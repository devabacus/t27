...
import 'package:t27_client/src/protocol/user/user_details.dart' as _i18;
import 'package:t27_client/src/protocol/user/role.dart' as _i19;
import 'package:t27_client/src/protocol/user/permission.dart' as _i20;
import 'package:t27_client/src/protocol/configuration.dart' as _i21;
import 'package:t27_client/src/protocol/user/customer.dart' as _i22;
import 'package:t27_client/src/protocol/user/super_user_details.dart' as _i23;
import 'package:t27_client/src/protocol/test_data.dart' as _i24;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i21.Configuration>) {
      return (data as List)
              .map((e) => deserialize<_i21.Configuration>(e))
              .toList()
          as T;
    }
    if (t == List<_i22.Customer>) {
      return (data as List).map((e) => deserialize<_i22.Customer>(e)).toList()
          as T;
    }
    if (t == List<_i23.SuperUserDetails>) {
      return (data as List)
              .map((e) => deserialize<_i23.SuperUserDetails>(e))
              .toList()
          as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is Map<String, dynamic> && data['__className__'] is String) {
      return (data['__className__'] as String).replaceFirst('t27.', '');
    }
    ...
    switch (data) {
      ...
      case _i4.Greeting():
        return 'Greeting';
      case _i5.SyncEventType():
        return 'SyncEventType';
      case _i6.TestData():
        return 'TestData';
      case _i7.Customer():
        return 'Customer';
      case _i8.CustomerUser():
        return 'CustomerUser';
      case _i9.Permission():
        return 'Permission';
      case _i10.Role():
        return 'Role';
      case _i11.RoleDetails():
        return 'RoleDetails';
      case _i12.RolePermission():
        return 'RolePermission';
      case _i13.SuperAdminDashboard():
        return 'SuperAdminDashboard';
      case _i14.SuperUserDetails():
        return 'SuperUserDetails';
      case _i15.UserDetails():
        return 'UserDetails';
      case _i16.UserSessionData():
